...
class Trainer(object):
    ...
    def validation(self):
        ...
        dataset_path = '/content/drive/MyDrive/Colab Notebooks/CCD/testing'
        with open('/content/drive/MyDrive/Colab Notebooks/CCD/test.txt', "r") as f:
...
def main():
    ...
    parser.add_argument('--dataset_path', type=str,
                        default='/content/drive/MyDrive/Colab Notebooks/CCD/train.txt')
    parser.add_argument('--type', type=str, default='train')
    parser.add_argument('--train_data_list_path', type=str,
                        default='/content/drive/MyDrive/Colab Notebooks/CDD/train.txt')
